 ...
 * T0 - Trial (8€, 14 days)
 * T1 - Basic membership (44€/month)
 * T2 - High Ticket Intensive (1,900€, 12 months)
 * T3 - Pro membership (97€/month, post-bootcamp)
 * T4 - B2B Dashboard (3,000€, 12 months)
 */
public enum SubscriptionTier {
    T0("Trial", new BigDecimal("8.00"), 14, false, false),
    T1("Basic", new BigDecimal("44.00"), 30, true, false),
